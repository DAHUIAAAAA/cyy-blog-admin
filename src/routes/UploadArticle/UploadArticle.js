...
import { uploadArticle } from '../../api/index'
...
class UploadArticle extends Component {
    ...
    render() {
        ...
        const button = <Button type="primary" htmlType="submit" className="login-form-button">上传文章</Button>
...
const uploadForm = Form.create({ name: 'upload_form' })(UploadArticle)
